...
if __name__ == "__main__":
    ...
    parent_url = click.prompt("URL of Homepage (www.<sitename>.com): ", type=str, default="www.psychobunny.com")
    csv_name_path = click.prompt("CSV of Image URL Reference Name:", type=str, default="default_image")
    
    #format url correct
    while parent_url.split(".")[0] != "www":
        parent_url = click.prompt("Please formate URL correctly -> 'www.<sitename>.com:': ", type=str, default="www.psychobunny.com")
